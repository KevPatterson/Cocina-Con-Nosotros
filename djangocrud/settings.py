...
LOGIN_REDIRECT_URL = '/change-password/'  # Cambiar la contraseña si ha expirado
...
SESSION_COOKIE_SAMESITE = 'Lax'  # Previene que las cookies se envíen desde sitios externos
